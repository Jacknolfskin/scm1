...
<body class="mybody">
	<form class="myfm" style="padding:15px;margin:0px;background:#eee;" id="ff" action="" method="post" >
		...
		<div class="myfitem2">
			...
			<label>日期：</label><input type="text" id="boDate" class="easyui-datetimebox"
		...
		<div class="myfitem2">	
			<label> 经手人：</label><input type="text" id="boOriginal" name="boOriginal" />
			<label>原始单号：</label><input type="text" 	id="boAttn" name="boAttn" /> 
